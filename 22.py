                    ...
                    if response.status_code == 200:
                        ...
                        for vacancy in vacancies:
                            ...
                            if (
                                ...
                                (not skills or any(skill.strip() in vacancy_data['requirements'] for skill in skills.split(','))) and
                                (not company or company in vacancy_data['company'])
                            ):
                                print('---')
                                print(f'Title: {vacancy_data["title"]}')
                                print(f'Company: {vacancy_data["company"]}')
                                print(f'Location: {vacancy_data["location"]}')
                                print(f'Requirements: {vacancy_data["requirements"]}')
                                print(f'Salary: {vacancy_data["salary"]}')
                                print(f'Link: {vacancy_data["link"]}')
